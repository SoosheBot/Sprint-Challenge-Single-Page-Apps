...
> Answer: The benefits of using client-side routing are speed (because it isn't loading the entire page of data--just what components you changed), and smoother transitions.
